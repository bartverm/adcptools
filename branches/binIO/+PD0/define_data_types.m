...
vbv.header='0A00';
vbv.nbins_block=vbl;
vbv.nbins_field=vbl.get_field_by_name('nbins');
...
vbc.header='0B00';
vbc.nbins_block=vbl;
vbc.nbins_field=vbl.get_field_by_name('nbins');
...
vbe.header='0C00';
vbe.nbins_block=vbl;
vbe.nbins_field=vbl.get_field_by_name('nbins');
...
vbp.header='0D00';
vbp.nbins_block=vbl;
vbp.nbins_field=vbl.get_field_by_name('nbins');
...
vbs.header='0E00';
vbs.nbins_block=vbl;
vbs.nbins_field=vbl.get_field_by_name('nbins');
